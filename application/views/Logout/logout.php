...
<html>
    <head>
        ...
        <link href="<?php echo base_url('asset'); ?>/horizontal/assets/css/metismenu.min.css" rel="stylesheet" type="text/css" />
    ...
    <body class="bg-accpunt-pages">
                                ...
                                <div class="account-box">
                                    <div class="text-center account-logo-box">
                                        <h2 class="text-uppercase">
                                            <a href="index.html" class="text-success">
                                                <span><img style="width: 150px;height: 150px" src="<?php echo base_url('asset/ksa.png') ?>" alt=""></span>
                                            </a>
                                        </h2>
                                    ...
                                    <div class="account-content">
                                        <div class="text-center m-b-20">
                                            ...
                                            <p class="text-muted font-13 m-t-10"> You are now successfully sign out. Back to <a href="<?php echo base_url('login'); ?>" class="text-primary m-r-5"><b>Sign In</b></a></p>
                                        </div>
        ...
        <script src="<?php echo base_url('asset'); ?>/horizontal/assets/js/metisMenu.min.js"></script>
